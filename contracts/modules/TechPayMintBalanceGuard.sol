...
import "./TechPayMintErrorCodes.sol";

// TechPayMintBalanceGuard implements a calculation of different rate steps
// between collateral and debt pools to ensure healthy accounts.
contract TechPayMintBalanceGuard is TechPayMintErrorCodes, ITechPayMintBalanceGuard
{
    // define used libs
    ...
    // Implements abstract function of the <TechPayMintRewardManager>.
