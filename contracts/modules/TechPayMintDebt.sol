...
// TechPayMintCore implements a calculation of different rate steps
// between collateral and debt pools to ensure healthy accounts.
contract TechPayMintDebt is Initializable, ReentrancyGuard, TechPayMintErrorCodes
{
    // define used libs
    ...
    function _repay(address _token, uint256 _amount) internal returns (uint256)
    {
        ...
        ITechPayDeFiTokenStorage pool = getDebtPool();
