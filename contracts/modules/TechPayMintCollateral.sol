...
contract TechPayMintCollateral is Initializable, ReentrancyGuard, TechPayMintErrorCodes
{
    // define used libs
    ...
    function _withdraw(address _token, uint256 _amount) internal returns (uint256) {
        ...
        ITechPayDeFiTokenStorage pool = ITechPayDeFiTokenStorage(getCollateralPool());
