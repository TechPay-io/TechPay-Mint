...
// TechPayMintCore implements a balance pool of collateral and debt tokens
// for the related TechPay DeFi contract. The collateral part allows notified rewards
// distribution to eligible collateral accounts.
contract TechPayMintRewardManager is TechPayMintErrorCodes, ITechPayMintRewardManager
{
    // define used libs
