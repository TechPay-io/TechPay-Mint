...
contract TechPayMintRewardDistribution is Initializable, Ownable, TechPayMintRewardManager
{
    // define used libs
    ...
    function rewardCanClaim(address _account) public view returns (bool) {
        return addressProvider.getTechPayMint().rewardCanClaim(_account);
    }
    ...
    function rewardIsEligible(address _account) public view returns (bool) {
        return addressProvider.getTechPayMint().rewardIsEligible(_account);
    }
}