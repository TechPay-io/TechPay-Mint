...
contract('Unit Test for TechPayLiquidationManager', function ([
  ...
  describe('depositing collateral and minting tUSD', function () {
    ...
    it('Scenario 2', async function () {
      ...
      await this.techpayLiquidationManager.bidAuction(1, new BN('50000000'), {
        from: bidder1
      });
    ...
    it('Scenario 3', async function () {
      ...
      await expectRevert(
        this.techpayLiquidationManager.bidAuction(1, new BN('100000000'), {
          from: bidder1
        }),
    ...
    /*  it('Scenario 4', async function(){
            ...
            *An admin starts the liquidation but it will fail with "Collateral is not eligible for liquidation"`);
            await expectRevert(this.techpayLiquidationManager.startLiquidation(borrower, {from: admin}),"Collateral is not eligible for liquidation");
        ...
        it('Scenario 5', async function(){
            ...
            *Event AuctionStarted should be emitted with correct values: nonce = 1, user = borrower`);
            ...
            await this.techpayTUSD.approve(this.techpayLiquidationManager.address, etherToWei(1500), {from: bidder1});

            console.log(`
            Bidder1 bids 25% of the collateral`);
            await this.techpayLiquidationManager.bidAuction(1, new BN('25000000'), {from: bidder1});
            ...
            *Bidder1's tUSD balance should be less than 10000`);
            ...
            await this.techpayTUSD.approve(this.techpayLiquidationManager.address, etherToWei(3900), {from: bidder2});

            console.log(`
            Bidder2 bids the rest of the collateral`);
            await this.techpayLiquidationManager.bidAuction(1, new BN('100000000'), {from: bidder2});
            ...
            *Bidder2's tUSD balance should be less than 10000`);
            ...
            console.log(`
            The amount of tUSD that bidder2 has spent is 10000 minus ${weiToEther(balance)}`);
            ...
            console.log(`
            The actual balance of techpayFeeVault's tUSD now: ${weiToEther(balance4)}`);
            ...
            *The tUSD techpayFeeVault's balance should be the same as total of tUSDs paid by bidder1 and bidder2`);
            ...
            console.log(`
            The actual amount of wTPC that bidder1 receives: `, weiToEther(balance));
            ...
            console.log(`
            The actual amount of wTPC that bidder2 receives: `, weiToEther(balance2));            
            ...
            console.log(`
            The amount of wTPC that borrower is refunded: ${weiToEther(balance3)}`)            
        ...
        it('Scenario 6', async function(){
            ...
            *Event AuctionStarted should be emitted with correct values: nonce = 1, user = borrower`);
            ...
            let liquidationDetails = await this.techpayLiquidationManager.getLiquidationDetails(1);
            console.log(`
            ...
            liquidationDetails = await this.techpayLiquidationManager.getLiquidationDetails(1);
            console.log(`
        ...
        it('Scenario 7', async function() {
            ...
            await this.mockToken.approve(this.techpayMint.address, etherToWei(5000), {from: borrower});
            await this.mockToken2.approve(this.techpayMint.address, etherToWei(4999), {from: borrower});
            ...
            await this.techpayMint.mustDeposit(this.mockToken.address, etherToWei(5000), {from: borrower});
            await this.techpayMint.mustDeposit(this.mockToken2.address, etherToWei(4999), {from: borrower});
            ...
            *Event AuctionStarted should be emitted with correct values: nonce = 1, user = borrower`);
            ...
            await this.techpayTUSD.approve(this.techpayLiquidationManager.address, etherToWei(7500), {from: bidder1});
            ...
            *The two amounts should be the same`);
            ...
            console.log(`
            The amount of wTPC that borrower is refunded: ${weiToEther(balance)}`);
            ...
            *The amount of bidder1's wTPC and borrower's should be 5000`);
            ...
            console.log(`
            The amount of wTPC2 that borrower is refunded: ${weiToEther(balance)}`);
